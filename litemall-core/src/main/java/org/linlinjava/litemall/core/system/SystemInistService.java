...
class SystemInistService {
    ...
    static {
        ...
        // 订单相关配置默认值
        DEFAULT_CONFIGS.put(SystemConfig.LITEMALL_MALL_NAME, "yibeigou");
        DEFAULT_CONFIGS.put(SystemConfig.LITEMALL_MALL_ADDRESS, "北京");
        DEFAULT_CONFIGS.put(SystemConfig.LITEMALL_MALL_PHONE, "182-2058-9178");
        DEFAULT_CONFIGS.put(SystemConfig.LITEMALL_MALL_QQ, "381016296");
    }
